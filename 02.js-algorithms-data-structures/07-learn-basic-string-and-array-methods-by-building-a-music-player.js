// Exercise permalink: https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures-v8/learn-basic-string-and-array-methods-by-building-a-music-player/step-1
...
const audio = new Audio();								// All modern browsers support the Web Audio API, which lets you generate and process audio in web applications. Use const to create a variable named audio and set it equal to new Audio(). This will create a new HTML5 audio element
let userData = {
  songs: [...allSongs],
  currentSong: null,
  songCurrentTime: 0,
...
/* An arrow function is an anonymous function expression and a shorter way to write functions. Anonymous means that the function does not have a name. Arrow functions are always anonymous. To create a named arrow function, you can assign the function to a variable:
...
audio.addEventListener("ended", () => {												// The "ended" event listener is fired when the playback of a media reaches the end
  const currentSongIndex = getCurrentSongIndex();
